...
public class QQWeibo2 extends Weibo {
	
	public QQWeibo2(String weiboName, String baseUrl, String factoryName,
	...
	protected void setDocumentType(ApiRequest request) {
		...
		request.addQueryParameter("oauth_consumer_key", QQWeibo2Factory.CONSUMER_KEY);
		request.addQueryParameter("oauth_version", "2.a");
	}
